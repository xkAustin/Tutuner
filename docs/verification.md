...
- `flutter doctor -v`（Flutter/JDK/Homebrew 完整工具路径）：通过，无问题
...
- Android Command-line Tools 22.0 已安装，SDK 包许可证状态为全部接受
...
- 品牌资源复检：通过
  - iOS App Icon 所有尺寸为不透明 PNG，由系统应用圆角蒙版
  - Android launcher 与启动图覆盖 mdpi 至 xxxhdpi，尺寸和透明圆角正确
  - macOS App Icon 覆盖 16–1024 px 并保留透明圆角
  - Windows ICO 包含 16、32、48、64、128、256 px 六档图像
  - Android APK 与 macOS App 已使用新品牌资源重新构建
